package org.jobportal.portal.aspects;
...
import org.jobportal.portal.exception.RegistrationValidationException;
...
public class RegisterValidationAspect {
    ...
    @Before("""
        execution(* org.jobportal.portal.auth.AuthController
        .registerUser(..))
        """)
